...
<title>上传头像</title>
<link type="text/css" rel="stylesheet" href="webapp/picture/css/css.css">
<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
<script src="webapp/picture/js/js.js"></script>
</head>
<body>
<div id="addCommodityIndex">
	<a href="myself/mycenter.jsp#" class="guanbi-i">
        <img class="img" src="webapp/img/popup_guanbi.png">
    </a>
    <div id="preview">
        <a href="myself/mycenter.jsp#">
        	<img id="imghead"  src="webapp/img/photo_icon.png" onclick="$('#previewImg').click();">
        </a>
    </div>
    <form action="UserPhoto" name="myform" method="post" enctype="multipart/form-data">
        ...
        <div class="tijiao">
            <a href="webapp/picture/picture.jsp#" class="tijiao-a">
